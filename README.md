...
## Technologies Used
- **JavaFX**: For creating the graphical user interface because it allows to build a responsive and interactive application that enhances user experience.

- **MS Azure**: The backend of the application is hosted on Microsoft Azure, which offers a secure and scalable environment.
  - **Azure SQL Database**: For storing all patient records, appointment information, billing details, and inventory data. It ensures data integrity and security.
  ...
  - **Azure org.education.hospitalmanagmentapp.App Service**: This service hosts the application, making it accessible to users from anywhere with an internet connection.

- **CSS**: Used CSS to style the application, ensuring a clean, modern, and visually appealing interface that enhances user engagement.